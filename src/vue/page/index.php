      ...
      <table class="w-full">
        ...
        <tbody>
          ...
          <tr class="m-0 border-t p-0 even:bg-[oklch(0.97 0 0)]"> 
            ...
            <td class="border text-left [&[align=center]]:text-center [&[align=right]]:text-right flex p-2 gap-2 "> 
            <a href="/edit/animal/'.$animal["id_animale"].'" class="px-2 bg-orange-400 text-orange-200 cursor-pointer rounded">✔</a>
